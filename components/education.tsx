      ...
      <div className="flex flex-col gap-8">
        <div className="flex flex-col gap-4 xl:grid grid-cols-5 xl:gap-0">
          <div className="col-span-4 flex flex-col gap-1">
            ...
            <p className="text-xs text-[#00c9c8]">Program's website: <a href="https://masterschool.eitdigital.eu/cloud-and-network-infrastructures" className="underline text-[#47817f] hover:text-[#bffcf9]">https://masterschool.eitdigital.eu/</a></p>
          </div>
        ...
        <div className="flex flex-col gap-4 xl:grid grid-cols-5 xl:gap-0">
          <div className="col-span-4 flex flex-col gap-1">
            ...
            <p className="text-xs text-[#00c9c8]">Program's website: <a href="https://telecos.upc.edu/en/study-programs/degrees/bachelors-degree-in-telecommunications-technologies-and-services-engineering/telematics-systems" className="underline text-[#47817f] hover:text-[#bffcf9]">https://telecos.upc.edu/en/</a></p>
          </div>
